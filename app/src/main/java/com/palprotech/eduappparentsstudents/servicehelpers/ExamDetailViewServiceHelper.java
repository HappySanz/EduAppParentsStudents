...
public class ExamDetailViewServiceHelper {
    ...
    public void makeGetExamDetailViewServiceCall(String params) {
        ...
        final JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.POST,
                EduAppConstants.BASE_URL + PreferenceStorage.getInstituteCode(context) + EduAppConstants.GET_EXAM_DETAIL_API, params,
    ...
    public void makeGetExamMarkViewServiceCall(String params) {
        Log.d(TAG, "making sign in request" + params);
        final JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.POST,
                EduAppConstants.BASE_URL + PreferenceStorage.getInstituteCode(context) + EduAppConstants.GET_EXAM_MARK_API, params,
                new com.android.volley.Response.Listener<JSONObject>() {
